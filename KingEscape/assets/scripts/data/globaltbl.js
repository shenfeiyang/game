...
var globaltbl = {
    data: [
        ...
        {id:5,description:"经验球最大数量",value:"75",},
        ...
        {id:10,description:"连击时间（秒）",value:"8",},
        ...
        {id:20,description:"飞镖飞行速度（秒）",value:"0.6",},
        {id:21,description:"护盾最大持续时间（秒）",value:"10",},
        {id:22,description:"护盾冷却时间（秒）",value:"12",},
        {id:23,description:"飞镖冷却时间（秒）",value:"10",},
        {id:24,description:"宝箱出现间隔（秒）",value:"40",},
        {id:25,description:"宝箱额外奖励经验",value:"200",},
        {id:26,description:"每日免费转盘次数",value:"1",},
        {id:27,description:"每日好友助力次数",value:"3",},
        {id:28,description:"每日视频抽取次数",value:"3",},
    ],
